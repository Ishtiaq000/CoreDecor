...
def addOrderItems(request):
    ...
    if orderItems and len(orderItems) == 0:
        ...
        # Create order items and set order and product to orderItems relationship
        for item in orderItems:
            # This will search the product from our model on the basis of id
            ...
            item = OrderItem.objects.create(
                ...
                order=order,
                name=product.name,
                qty=item["qty"],  # Getting from frontend
                # Getting price from frontend because admin may be updated the price after user's checkout and user is not aware of that
                price=item["price"],
